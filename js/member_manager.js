...
const DEFAULT_MEMBERS = [
  { id: "mem_1", name: "정다운", level: 3.5, tier: "A", group: "A조", role: "회장", status: "active", phone: "010-1111-0001" },
  { id: "mem_2", name: "송영수", level: 3.5, tier: "A", group: "B조", role: "부회장", status: "active", phone: "010-1111-0002" },
  { id: "mem_3", name: "김명중", level: 3.5, tier: "A", group: "A조", role: "경기이사", status: "active", phone: "010-1111-0003" },
  { id: "mem_4", name: "정민석", level: 3.0, tier: "B", group: "B조", role: "재무이사", status: "active", phone: "010-1111-0004" },
  { id: "mem_5", name: "안정환", level: 3.0, tier: "B", group: "C조", role: "총무이사", status: "active", phone: "010-1111-0005" },
  ...
  { id: "mem_8", name: "양용빈", level: 2.5, tier: "C", group: "D조", role: "회원", status: "active", phone: "010-1111-0008" },
  ...
  { id: "mem_13", name: "전동훈", level: 3.0, tier: "B", group: "A조", role: "회원", status: "active", phone: "010-1111-0013" }
];

class MemberManager {
  constructor() {
    this.storageKey = "tennis_club_members_v2";
